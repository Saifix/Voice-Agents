// Full list of country dial codes (ISO 3166-1 alpha-2 + E.164 calling code),
// sorted by country name. ISO code is used as the unique <select> value since
// several countries share a dial code (e.g. +1, +7).
